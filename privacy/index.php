...
<div id="wrap_main">
    <div id="spchangePrivacy" class="spchangePrivacy">
            <div id="main">
            <!--sidenav-->
            ...
            <div id="contents">
                ...
                <h2>
                    <picture class="kakushu_btn kakushu_btn_privacy kakushu_btn_privacyTitle">
                        <source media="(min-width: 768px)" srcset="ti_privacy.jpg"><!--PC画像-->
                        <source media="(max-width: 768px)" srcset="ti_privacySp.jpg"><!--SP画像-->
                        <img src="ti_privacy.jpg" alt="プライバシーポリシー" width="680" height="30" />
                    </picture>
                </h2>
                <br />
                <p class="size14">
                    はじめに<br />
                    <br />
                    個別指導レビュー（以下、「弊社」）は、各種法的サービスのご提供にあたり、お客様の個人情報をお預かりしております。<br />
                    ...
                    弊社は、個人情報の取り扱いの全部または一部を第三者に委託する場合は、
                    当該第三者について厳正な調査を行い、
                    ...
                    電話：050-1793-5421<br />
                    <span class="tel-note">※24時間対応しておりますので、<br>いつでもお気軽にご連絡ください。</span><br />
                    <br />
                    <strong>７．組織・体制</strong><br />
                    弊社は、代表　練尾教世 を個人情報管理責任者とし、個人情報の適正な管理及び継続的な改善を実施致します。 <br />
                    <br />
                    <strong> ８．本方針の変更</strong><br /> 
                    本方針の内容は変更されることがあります。

                    変更後の本方針については、弊社が別途定める場合を除いて、当サイトに掲載した時から効力を生じるものとします </p><br />
                <br />
